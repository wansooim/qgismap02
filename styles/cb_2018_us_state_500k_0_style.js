...
var style_cb_2018_us_state_500k_0 = function(feature, resolution){
    ...
    if (value >= 158340391.000000 && value <= 20205125364.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 20205125364.000000 && value <= 106802728188.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 106802728188.000000 && value <= 144661267977.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 144661267977.000000 && value <= 212886221680.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 212886221680.000000 && value <= 1478839695958.000000) {
            style = [ new ol.style.Style({
